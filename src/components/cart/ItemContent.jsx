        ...
        <div className="grid md:grid-cols-5 grid-cols-4 md:text-md text-sm gap-4   items-center  border-[1px] border-slate-200  rounded-md  lg:px-4  py-4 p-2">
            <div className="md:col-span-2 justify-self-start flex  flex-col gap-2 ">
                <div className="flex md:flex-row flex-col lg:gap-4 sm:gap-3 gap-0 items-start ">
                   <h3 className="lg:text-[20px] text-sm font-semibold text-slate-600">
                ...
                <div className="md:w-36 sm:w-24 w-12">
                    <img 
                        src={`http://localhost:8080/images/359c7094-6ed1-493c-9f0b-b00dee7b87ca.jpg`}
                        alt={productName}
                        className="md:h-20 sm:h-18 h-16 w-full object-cover rounded-md"/>
            ...
            <div className="justify-self-center lg:text-[25px] text-2xl text-slate-800 font-semibold">
