...
const ProductCard = ({
    ...
    return (
    <div className=' border-b-2 border-b-neutral-800 rounded-sm shadow-lg overflow-hidden transition-shadow duration-300'>
        <div onClick={() => {
            handleProductView({
                id : productId,
                productName,
        ...
        <div className='p-4'>
            ...
            }} className='text-2xl font-bold mb-2 cursor-pointer text-pink-700'>{productName}</h2>
