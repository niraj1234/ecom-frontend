        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
           ...
           <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <p className="text-2xl mb-4 mr-20">
                ...
                <div className="w-full md:w-1/2 mb-6 md:mb-0">
                    <img
                        src="https://picomimages.s3.ap-south-1.amazonaws.com/imgn/simariyapul-02.jpg"
                        alt="About Us"
           ...
           <div className="py-7 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
               {products.map( (product, index) => (
                <div className='bg-gray-100 border-1 border-lime-400 p-5 rounded-sm'>
                    <h1 className='text-xl mb-2 font-semibold'>{product.productName}</h1>
